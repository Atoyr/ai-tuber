...
/// <summary>
/// live / voicevox / purupuru の状態を合成した SSE state イベントの発行係。
...
public sealed class StudioStateNotifier
{
    ...
    private (string Live, string Voicevox, string Purupuru)? _last;
    ...
    public void PublishIfChanged()
    {
        ...
        _broker.Publish(SseEventMapper.State(current.Live, current.Voicevox, current.Purupuru));
    }
}
